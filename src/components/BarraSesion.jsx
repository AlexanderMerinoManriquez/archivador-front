      ...
      {abierto && (
        <div className="absolute right-0 z-20 mt-1.5 w-60 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-lg">
          ...
          <div className="border-t border-slate-100 py-1">
            <button type="button" onMouseDown={(e) => e.stopPropagation()} onClick={cerrarSesion} className="flex w-full cursor-pointer items-center gap-2 px-3.5 py-2.5 text-left text-sm text-slate-700 transition-colors hover:bg-red-50 hover:text-red-600">
              <LogOut size={15} />
              Cerrar sesión
            </button>
          </div>
